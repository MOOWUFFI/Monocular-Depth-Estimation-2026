#!/bin/bash
#SBATCH --job-name=resnet_base_aspp_eagle
#SBATCH --time=10:00:00
#SBATCH --gpus=5060ti:1
#SBATCH --mem=48G
#SBATCH --cpus-per-gpu=8
#SBATCH --exclude=studgpu-node09
#SBATCH --output=logs/resnet_base_aspp_eagle_%j.out
#SBATCH --error=logs/resnet_base_aspp_eagle_%j.err
#
# Experiment 4: + EAGLE (two-stage EAM).
#   - everything in base_aspp.sh
#   - EAGLE EiCue heads at encoder stages [2, 3] (multi-scale)
...
OUTPUT_DIR="${OUTPUT_DIR:-approaches/Resnet/results/base_aspp_eagle}"
