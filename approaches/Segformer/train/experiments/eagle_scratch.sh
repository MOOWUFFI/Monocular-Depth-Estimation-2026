#!/bin/bash
#SBATCH --job-name=segformer_eagle_scratch
#SBATCH --time=12:00:00
#SBATCH --gpus=5060ti:1
#SBATCH --mem=32G
#SBATCH --cpus-per-gpu=4
#SBATCH --output=logs/segformer_eagle_scratch_%j.out
#SBATCH --error=logs/segformer_eagle_scratch_%j.err
#
# SegFormer-B0 + EAGLE from scratch:
#   - encoder loaded from the pretrained SegFormer-B0 (no Stage-2 distillation)
...
PROJ_DIR="${PROJ_DIR:-approaches/Segformer/results/eagle_scratch}"
